...
public class RushConfig : ScriptableObject
{
    ...
    public DifficultyTier[] difficultyTiers = new DifficultyTier[]
    {
        ...
        new DifficultyTier { startTime = 15f,  fallSpeed = 2.8f, maxRows = 4, safeCorridorFraction = 0.35f, complexPatternWeight = 0.4f, poisonGemChance = 0f, wavePauseOverride = 2.5f },
        new DifficultyTier { startTime = 40f,  fallSpeed = 3.2f, maxRows = 4, safeCorridorFraction = 0.3f,  complexPatternWeight = 0.6f, poisonGemChance = 0f, wavePauseOverride = 2.0f },
        new DifficultyTier { startTime = 75f,  fallSpeed = 3.6f, maxRows = 5, safeCorridorFraction = 0.25f, complexPatternWeight = 0.8f, poisonGemChance = 0f, wavePauseOverride = 1.5f },
        new DifficultyTier { startTime = 120f, fallSpeed = 4.0f, maxRows = 5, safeCorridorFraction = 0.2f,  complexPatternWeight = 1.0f, poisonGemChance = 0f, wavePauseOverride = 1.2f },
    };
